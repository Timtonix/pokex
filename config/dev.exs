...
config :poker, PokerWeb.Endpoint,
  ...
  code_reloader: true,
  debug_errors: true,
  secret_key_base: "nKZaHmrVW3tXOqSCTyZK7y8AXUJQkTRv0IX6n2OnPwViqQRofEYhiC6CemClkLiE",
  watchers: [
...
config :poker, PokerWeb.Endpoint,
  live_reload: [
    ...
    patterns: [
      ...
      ~r"lib/poker_web/router\.ex$",
      ~r"lib/poker_web/(controllers|live|components)/.*\.(ex|heex)$"
    ]
  ]
